...
import '../components/dashboard/completed_drill_card.dart';
import '../models/drill_plan.dart';

class CompletedDrillsPage extends StatefulWidget {
  const CompletedDrillsPage({super.key});

  @override
  State<CompletedDrillsPage> createState() => _CompletedDrillsPageState();
}

class _CompletedDrillsPageState extends State<CompletedDrillsPage> {
                ...
                children: [
                  ...
                  if (true)
                    WebNavBar(
                      ...
                      navColorTwo: FFTheme.of(context).secondaryText,
                      navBgThree: FFTheme.of(context).primaryBackground,
                      navColorThree: FFTheme.of(context).primaryText,
                            ...
                            child: RichText(
                              text: TextSpan(
                                ...
                                children: [
                                  const TextSpan(
                                    text:
                                        'Looking for an upcoming drill? Try the ',
                                  ),
                                  TextSpan(
