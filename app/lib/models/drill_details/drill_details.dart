...
class DrillDetails {
      ...
      : drillID = '123abc',
        ...
        tasks = [
          ...
          DrillTask(
            ...
            taskType: DrillTaskType.reqLocPerms,
          ...
          DrillTask(
            ...
            taskType: DrillTaskType.waitForStart,
          ...
          DrillTask(
            ...
            taskType: DrillTaskType.practiceEvac,
            details: PracticeEvacDetails.example('abc123-5'),
          ),
          DrillTask(
            index: 6,
            taskID: 'abc123-6',
      ...
      : drillID = '123abc',
        ...
        tasks = [
          ...
          DrillTask(
            ...
            title: 'Perform the Tsunami Evacuation Drill',
            taskType: DrillTaskType.practiceEvac,
            details: PracticeEvacDetails.example('abc123-3'),
          ),
          DrillTask(
            index: 4,
            taskID: 'abc123-4',
      ...
      : drillID = 'testTelemetry',
        ...
        tasks = [
          ...
          DrillTask(
            ...
            taskType: DrillTaskType.practiceEvac,
            details: PracticeEvacDetails.example('perform-telemetryTest'),
          ),
        ];
  ...
  factory DrillDetails.fromJson(Map<String, dynamic> json, String drillID) {
    ...
    if (json['meetingDateTime'] != null) {
      try {
        meetingDateTime =
            DateTime.tryParse(json['meetingDateTime'].toDate().toString());
      } catch (e) {
        throw Exception(
