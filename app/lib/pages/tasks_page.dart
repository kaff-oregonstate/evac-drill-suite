...
import 'package:evac_app/task_displays/practice_evac_display.dart';
...
class _TasksPageState extends State<TasksPage> {
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  child: CupertinoButton.filled(
                    ...
                    onPressed: getButtonFunction(context, index, setState),
                  ),
                ),
              ),
            )
    ...
    if (foundMatch) {
      switch (task.taskType) {
        ...
        case DrillTaskType.practiceEvac:
          final result = matchingResult as PracticeEvacResult;
          return result.completed;
  ...
  void Function() getButtonFunction(
    ...
    switch (drillTask.taskType) {
      ...
      case DrillTaskType.practiceEvac:
        return _makePracticeEvacButtonFunction(
  ...
  void Function() _makeWaitForStartButtonFunction(BuildContext context,
    ...
    void _waitForStartButtonFunction() {
      // get the PracticeEvacDetails from DrillDetails
      final practiceEvacDetails = performDetails as PracticeEvacDetails;

      // create the function which will be called inside WaitForStartDisplay that
      // pushes the PracticeEvacDisplay
      void pushPracticeEvac() {
        // Navigator.push PracticeEvac route
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(
            ...
            builder: (context) =>
                // need to add back/exit button!!!
                PracticeEvacDisplay(
              practiceEvacDetails: practiceEvacDetails,
              userID: widget.drillResults.userID,
              setPracticeEvacResult: makePracticeEvacResultSetter(
                  widget.drillResults, practiceEvacDetails, setState),
            ),
          ),
        );
      }
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          ...
          builder: (context) =>
              // need to add back/exit button!!!
              WaitForStartDisplay(
                  pushPracticeEvac: pushPracticeEvac,
  ...
  void Function() _makePracticeEvacButtonFunction(
      BuildContext topContext, TaskDetails waitDetails) {
    void _practiceEvacButtonFunction() {
    ...
    return _practiceEvacButtonFunction;
  }
